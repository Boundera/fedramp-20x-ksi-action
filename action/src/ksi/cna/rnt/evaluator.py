...
Evaluates Terraform configuration for compliance with KSI-CNA-RNT:
...
def evaluate_cna_rnt_a(inventory: NetworkInventory) -> CNA01CriterionResult:
...
def evaluate_cna_rnt_b(inventory: NetworkInventory) -> CNA01CriterionResult:
...
def evaluate_cna_rnt_c(inventory: NetworkInventory) -> CNA01CriterionResult:
...
def evaluate_cna_rnt_d(trigger_event: str) -> CNA01CriterionResult:
...
def evaluate_cna_rnt(
    ...
    criteria["CNA01-A"] = evaluate_cna_rnt_a(inventory)
    criteria["CNA01-B"] = evaluate_cna_rnt_b(inventory)
    criteria["CNA01-C"] = evaluate_cna_rnt_c(inventory)
    criteria["CNA01-D"] = evaluate_cna_rnt_d(trigger_event)
