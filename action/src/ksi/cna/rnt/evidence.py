"""Evidence pack generation for KSI-CNA-RNT.
...
class CNA01EvidencePackBuilder:
    """Builder for FedRAMP KSI-CNA-RNT evidence pack."""
    ...
    def __init__(self, output_dir: str | Path = "."):
        ...
        self.evidence_dir = self.output_dir / "evidence" / "ksi-cna-rnt"
    ...
    def write_json_file(
        ...
        if subdir:
            ...
            rel_path = f"evidence/ksi-cna-rnt/{subdir}/{filename}"
        else:
            target_dir = self.evidence_dir
            rel_path = f"evidence/ksi-cna-rnt/{filename}"
    ...
    def write_hashes(self) -> None:
        ...
        self.files_written.append(
            ("evidence/ksi-cna-rnt/hashes.sha256", "SHA-256 hashes of all evidence files")
        )
...
def build_cna_rnt_evidence_pack(
    output_dir: str | Path,
